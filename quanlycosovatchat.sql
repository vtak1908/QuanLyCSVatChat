...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 20, 2025 lúc 03:00 PM
...
(26, 'Máy chiếu', 'maychieu.png', 'Điện tử', 'Tốt', 'Phòng 101', '2024-12-20'),
(27, 'Bảng', 'bang.jpg', 'Nội thất', 'Tốt', 'Phòng 102', '2025-01-01'),
(28, 'Máy tính', 'maytinh.png', 'Điện tử', 'Tốt', 'Phòng 405', '2025-01-09'),
(29, 'Bàn học', 'banhoc.png', 'Nội thất', 'Đang sửa chữa', 'Phòng 405', '2025-01-20');
...
(10, 29, '2025-01-20', 'Hỏng', 'Đang xử lý');
...
--
ALTER TABLE `assets`
  MODIFY `Id_Assets` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
